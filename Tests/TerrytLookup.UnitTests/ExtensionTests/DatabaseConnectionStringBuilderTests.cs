...
//
// namespace TerrytLookup.UnitTests.ExtensionTests;
//
...
//
//         //Act
//         var exception = Assert.Throws<InvalidDatabaseConfigurationException>(() => configuration.GetConnectionString());
//
//         //Assert
...
//             exception.Message,
//             Is.EqualTo(
//                 "'DbConnection:DefaultConnection:User' value missing in configuration and no 'POSTGRES_USER' in environment variables"));
//     }
//
//     [Test]
...
//             exception.Message,
//             Is.EqualTo(
//                 "'DbConnection:DefaultConnection:Password' value missing in configuration and no 'POSTGRES_PASSWORD' in environment variables"));
//     }
//
//     [Test]
...
//         Assert.That(
//             exception.Message,
//             Is.EqualTo("Value missing from configuration: DbConnection:DefaultConnection:Host."));
//     }
//
//     [Test]
