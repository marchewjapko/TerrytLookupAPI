...
public class CountyRepositoryTests
{
    ...
    public async Task BrowseAllAsync_ShouldReturnAllCounties()
    {
        ...
        var specification = new CountyGetByFilterSpecification(pageSize);
    ...
    public async Task BrowseAllAsync_ShouldFilterByName()
    {
        ...
        var validCounty = new Faker<County>()
            .RuleFor(x => x.VoivodeshipId, _ => 1)
            .RuleFor(x => x.Name, _ => filterName)
            .RuleFor(x => x.CountyId, _ => counties.Max(x => x.CountyId) + 1)
            .Generate();
        ...
        var specification = new CountyGetByFilterSpecification(pageSize, filterName);
    ...
    public async Task BrowseAllAsync_ShouldFilterByVoivodeshipId()
    {
        ...
        var validCounties = new Faker<County>()
            .RuleFor(x => x.VoivodeshipId, _ => 3)
        ...
        var specification = new CountyGetByFilterSpecification(pageSize, voivodeshipId: newVoivodeship.Id);
    ...
    public async Task GetByIdAsync_ShouldReturnCounty()
    {
        ...
        var countyId = counties.First()
            .CountyId;

        var voivodeshipId = counties.First()
            .VoivodeshipId;

        var specification = new CountyGetByIdSpecification(voivodeshipId, countyId);
    ...
    {
        //Arrange
        var specification = new CountyGetByIdSpecification(1, 1);
